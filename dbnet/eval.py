...
class EVAL():
    ...
    def eval(self):
        ...
        total_frame = 0.0
        total_time = 0.0
        print("len(self.validate_loader:",len(self.validate_loader))
...
def init_args():
    ...
    parser.add_argument('--model_path', required=False, default='/home/share/gaoluoluo/dbnet/output/DBNet_resnet18_FPN_DBHead/checkpoint/model_best.pth', type=str)
